  ...
  return (
    <div className="space-y-6 sm:space-y-12 pb-2 sm:pb-8">
      <div className="text-center space-y-3 sm:space-y-6 px-3 sm:px-4">
        <h2 id="home-title" className="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-yellow-300 mb-2 sm:mb-4 a-fade-up scroll-mt-24">
      ...
      <div className="mt-4 sm:mt-12 px-3 sm:px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6 md:a-stagger max-w-6xl mx-auto">
      ...
      <div className="mt-4 sm:mt-12 px-3 sm:px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-4 md:a-stagger max-w-5xl mx-auto">
          <div className="bg-black/50 border border-yellow-300/20 p-3 sm:p-6 rounded-lg shadow-md aura-card text-center md:a-pop a-wall-build">
