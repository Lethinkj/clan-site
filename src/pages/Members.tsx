...
export default function Members() {
  return (
    <div className="space-y-4 sm:space-y-8">
      <section>
        <h2 className="text-2xl sm:text-4xl font-bold text-yellow-300 mb-2 a-fade-up px-3 sm:px-0">Captain Bash</h2>
        <p className="text-sm sm:text-base text-aura mb-3 sm:mb-6 a-fade-up px-3 sm:px-0">Members (2)</p>

        <div className="grid grid-cols-1 md:grid-flow-col md:auto-cols-fr gap-3 sm:gap-6 a-stagger justify-items-center px-3 sm:px-0">
          {captains.map((member, i) => (
            <article key={i} className="w-full bg-black/50 border border-yellow-300/20 p-4 sm:p-6 rounded-lg shadow-md aura-card transition-all a-fade-up">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-6 a-stagger justify-items-center px-3 sm:px-0">
          {teamMembers.map((member, i) => (
            <article key={i} className="w-full bg-black/50 border border-yellow-300/20 p-3 sm:p-5 rounded-lg shadow-md aura-card transition-all a-fade-up">
